...
description: Get started with the Java Learning Hub in 5 minutes. Choose your learning path, set up your environment, and begin coding.
---
...
- **Complete Beginner?** → Start with [Java Basics](java-basics/index.md)
...
[Explore All Resources →](resources.md){ .md-button }
...
Download JDK from [Oracle](https://www.oracle.com/java/technologies/downloads/){ target=_blank } or use OpenJDK.
...
[Start with Java Basics :material-arrow-right:](java-basics/index.md){ .md-button .md-button--primary }
[Jump to OOP](oops/index.md){ .md-button }
[Practice DSA](dsa/index.md){ .md-button }
